    ...
    <div className="bg-neutralSliver" id="home">
      ...
      <div className="app">
        <div className="header-container">
          <h1
            className="text-2xl md:text-4xl text-[#263238] font-medium"
            data-aos="fade-up"
          >
        ...
        <div className="features-container">
          <div className="feature bg-[#f5f5f5] p-10" data-aos="fade-up">
            ...
            <h3 className="text-center">
              REAL-WORLD EXPERIENCE FIRST-HAND KNOWLEDGE
            </h3>
            <p>
              With each project, our skilled consultants utilize cutting-edge
              methodologies and expertise accumulated over years of involvement
              in corporate software development. Notably, both our leadership
              team and consultants boast rich backgrounds, particularly within
              the domain of software engineering and technology.
            </p>
          </div>
          <div className="feature bg-[#f5f5f5] p-10" data-aos="fade-up">
            <h2>FLEXIBILITY</h2>
            ...
            <p>
              Tailored Services: As a privately-owned firm imbued with a robust
              entrepreneurial ethos, we possess the capacity to tackle
              intricate, enterprise-scale projects while remaining agile enough
              to adapt to your unique needs. This affords us the flexibility
              required to collaborate with clients in innovative and
              accommodating ways.
            </p>
          </div>
          <div className="feature bg-[#f5f5f5] p-10" data-aos="fade-up">
            ...
            <h3 className="text-center">
              EXCEPTIONAL SERVICES AT AN EXCEPTIONAL VALUE
            </h3>
            <p>
              Doing more with less is essential in today's economic landscape.
              Our company's size, expertise, and strategic approach empower us
              to deliver exceptional value to clients without compromising on
          ...
          <div className="feature bg-[#f5f5f5] p-10" data-aos="fade-up">
            ...
            <p>
              Our proven track record and results-driven approach ensure that we
              deliver the outcomes essential for your business. We address your
              most critical technological and business challenges by merging our
              established project management proficiency with expertise and a
              steadfast work ethic.
            </p>
          </div>
        </div>
      </div>
