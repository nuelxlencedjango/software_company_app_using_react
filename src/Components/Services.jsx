...
const Services = () =>{
    const services = [
        {id: 1, title: "Software Products Development", description:"Revolutionize Your Operations with RaddoTech's Software Products Development. In the ever-evolving landscape of technology, the key to staying competitive lies in the strategic development of software products that not only meet the current demands but also anticipate future challenges. Welcome to RaddoTech, where our Software Products Development services are designed to transform your vision into innovative, reliable, and scalable digital solutions.Why Choose RaddoTech for your  Software Products Development?",
    icon: (<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-14 h-14 text-white">
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 0 0 8.716-6.747M12 21a9.004 9.004 0 0 1-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 0 1 7.843 4.582M12 3a8.997 8.997 0 0 0-7.843 4.582m15.686 0A11.953 11.953 0 0 1 12 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0 1 21 12c0 .778-.099 1.533-.284 2.253m0 0A17.919 17.919 0 0 1 12 16.5c-3.162 0-6.133-.815-8.716-2.247m0 0A9.015 9.015 0 0 1 3 12c0-1.605.42-3.113 1.157-4.418" />
  </svg>
  )
  
},
    {id: 2, title: "Product Designs", description:"Crafting enjoyable user experiences for your products is crucial. The quality of these experiences often serves as the determining factor in completing transactions, sustaining user engagement, advocating for a product to peers, sharing feedback on social media, fostering customer loyalty through repeat purchases, or potentially exploring offerings from competitors",
    icon: (
    ...
    {id: 3, title: "Data Engineering & AI Solution", description:"Harnessing the power of large-scale data to enhance operational efficiency, facilitate informed decision-making, and drive overall company growth.",
    icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-14 h-14 text-white">
  ...
  {id: 5, title: "Cybersecurity Consulting", description:"Implement the appropriate security strategy and practices to safeguard both your business and customers.",
  icon: (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-14 h-14 text-white">
...
{id: 7, title: "Training And Coaching", description:"Mastery of popular programming languages such as Python, Java, JavaScript, C++, and others forms the foundation of software development training.",
icon: (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-14 h-14 text-white">
