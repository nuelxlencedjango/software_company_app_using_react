...
const Products = () => {
  ...
  return (
    <div
      className="px-4 lg:px-14 py-[80px] lg:py-[120px] max-w-screen-2x1 mx-auto"
      id="products"
    >
      <div className="text-center md:w-2/2 mx-auto">
        <h2
          className="text-4xl text-neutralDGrey font-semibold mb-4 md:w-5/5"
          data-aos="fade-up"
        >
          We make Exceptional Software Products <span>like</span>
        </h2>
        <p
          className="md:w-5/6 text-sm text-neutralGrey mb-10 mx-auto"
          data-aos="fade-up"
        >
          Transform your business with our exceptional products. Elevate and
          expand your operations using our comprehensive software suite,
          meticulously crafted to seamlessly manage every aspect of your
          enterprise. Leveraging our profound technical expertise and industry
          knowledge, we engineer forward-looking solutions to empower your
      ...
      >
        {blogs.map((blog) => (
          <div
            key={blog.id}
            className="relative mb-12 cursor-pointer hover:scale-95 translate-all duration-300"
            data-aos="fade-up"
          >
            <div
              className="bg-cover bg-center h-72 rounded-lg overflow-hidden"
            ...
            <div className="text-center px-4 py-8 bg-white shadow-lg rounded-md md:w-3/4 mx-auto absolute left-0 right-0 -bottom-12">
              ...
              <p className="mb-2 text-neutralGrey font-16">
                {truncateText(blog.text, 10)}
              </p>
              <div className="flex items-center justify-center gap-8">
                <a
                  href="/"
                  className="font-bold text-neutralBlue hover:text-neutral-700"
                >
                  Read more
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
